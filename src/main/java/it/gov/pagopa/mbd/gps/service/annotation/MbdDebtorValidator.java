...
public class MbdDebtorValidator implements ConstraintValidator<ValidMbdDebtor, MbdPaymentOptionRequestProperties> {

    @Override
    public boolean isValid(MbdPaymentOptionRequestProperties properties, ConstraintValidatorContext context) {
